...
public class QuizLauncher extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        introcard.setOnClickListener(v -> startActivity(new Intent(QuizLauncher.this, IntroQuizActivity.class)));

    }
    @Override
    public void onBackPressed() {
        // Dialog when user presses the back button
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(QuizLauncher.this);
