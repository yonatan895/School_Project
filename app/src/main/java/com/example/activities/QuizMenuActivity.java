...
public class QuizMenuActivity extends BaseActivity {
  ...
  /**
   * The onBackPressed function is a function that allows the user to exit the app by pressing the
   * back button. The function displays an alert dialog asking if they are sure they want to exit,
   * and then exits if yes is pressed. If no is pressed, it dismisses the dialog and returns them to
   * their previous activity (in this case QuizMenu). This was implemented because I felt like it
   * would be more intuitive for users than having nothing happen when they press back on this
   * screen. It also prevents them from accidentally exiting out of my app when trying to go back
   * one screen in my navigation drawer menu.
   */
  @Override
  public void onBackPressed() {
    MaterialAlertDialogBuilder materialAlertDialogBuilder =
        new MaterialAlertDialogBuilder(QuizMenuActivity.this);
    materialAlertDialogBuilder.setTitle(R.string.app_name);
    materialAlertDialogBuilder.setMessage(
        "Are you sure you want to exit to the main app? There are plenty of quizzes for you :)");
